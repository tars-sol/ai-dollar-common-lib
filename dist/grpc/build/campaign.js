...
function createBaseGetProfileCampaignProgressRequest() {
    return { campaignId: "", profileId: "" };
}
exports.GetProfileCampaignProgressRequest = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        if (message.campaignId !== "") {
            writer.uint32(10).string(message.campaignId);
        }
    ...
    create(base) {
        return exports.GetProfileCampaignProgressRequest.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseGetProfileCampaignProgressRequest();
        message.campaignId = object.campaignId ?? "";
...
function createBaseProfileCampaignTaskProgressItem() {
    return { taskId: "", isCompleted: false, progressCount: 0 };
}
exports.ProfileCampaignTaskProgressItem = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        if (message.taskId !== "") {
    ...
    create(base) {
        return exports.ProfileCampaignTaskProgressItem.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseProfileCampaignTaskProgressItem();
        message.taskId = object.taskId ?? "";
...
function createBaseGetProfileCampaignProgressResponse() {
    return { items: [] };
}
exports.GetProfileCampaignProgressResponse = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        for (const v of message.items) {
            exports.ProfileCampaignTaskProgressItem.encode(v, writer.uint32(10).fork()).join();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1: {
                    ...
                    message.items.push(exports.ProfileCampaignTaskProgressItem.decode(reader, reader.uint32()));
                    continue;
                }
            }
            if ((tag & 7) === 4 || tag === 0) {
    ...
    fromJSON(object) {
        return {
            items: globalThis.Array.isArray(object?.items)
                ? object.items.map((e) => exports.ProfileCampaignTaskProgressItem.fromJSON(e))
                : [],
        };
    },
    toJSON(message) {
        ...
        if (message.items?.length) {
            obj.items = message.items.map((e) => exports.ProfileCampaignTaskProgressItem.toJSON(e));
        }
        return obj;
    },
    create(base) {
        return exports.GetProfileCampaignProgressResponse.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseGetProfileCampaignProgressResponse();
        message.items = object.items?.map((e) => exports.ProfileCampaignTaskProgressItem.fromPartial(e)) || [];
        return message;
    },
};
function createBaseTrendingCampaignsRequest() {
    return { pageNumber: undefined };
}
exports.TrendingCampaignsRequest = {
    encode(message, writer = new wire_1.BinaryWriter()) {
    ...
    create(base) {
        return exports.TrendingCampaignsRequest.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseTrendingCampaignsRequest();
...
exports.TrendingCampaignItem = {
    ...
    create(base) {
        return exports.TrendingCampaignItem.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseTrendingCampaignItem();
        message.id = object.id ?? "";
...
function createBaseTrendingCampaignsResponse() {
    return { campaigns: [], total: 0 };
}
exports.TrendingCampaignsResponse = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        for (const v of message.campaigns) {
            exports.TrendingCampaignItem.encode(v, writer.uint32(10).fork()).join();
        }
        if (message.total !== 0) {
            writer.uint32(16).int32(message.total);
        }
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1: {
                    ...
                    message.campaigns.push(exports.TrendingCampaignItem.decode(reader, reader.uint32()));
                    continue;
                }
                case 2: {
                    if (tag !== 16) {
    ...
    fromJSON(object) {
        return {
            campaigns: globalThis.Array.isArray(object?.campaigns)
                ? object.campaigns.map((e) => exports.TrendingCampaignItem.fromJSON(e))
                : [],
            total: isSet(object.total) ? globalThis.Number(object.total) : 0,
        };
    },
    toJSON(message) {
        const obj = {};
        if (message.campaigns?.length) {
            obj.campaigns = message.campaigns.map((e) => exports.TrendingCampaignItem.toJSON(e));
        }
        if (message.total !== 0) {
            obj.total = Math.round(message.total);
        }
    ...
    create(base) {
        return exports.TrendingCampaignsResponse.fromPartial(base ?? {});
    },
    fromPartial(object) {
        const message = createBaseTrendingCampaignsResponse();
        message.campaigns = object.campaigns?.map((e) => exports.TrendingCampaignItem.fromPartial(e)) || [];
        message.total = object.total ?? 0;
        return message;
    },
};
...
class CampaignServiceClientImpl {
    ...
    GetProfileCampaignProgress(request) {
        const data = exports.GetProfileCampaignProgressRequest.encode(request).finish();
        const promise = this.rpc.request(this.service, "GetProfileCampaignProgress", data);
        return promise.then((data) => exports.GetProfileCampaignProgressResponse.decode(new wire_1.BinaryReader(data)));
    }
    TrendingCampaigns(request) {
        const data = exports.TrendingCampaignsRequest.encode(request).finish();
        const promise = this.rpc.request(this.service, "TrendingCampaigns", data);
        return promise.then((data) => exports.TrendingCampaignsResponse.decode(new wire_1.BinaryReader(data)));
    }
}
